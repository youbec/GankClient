...
public class ResourceFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private MainBeanView mainBeanView = new MainBeanView() {
        ...
        public void onSuccess(final MainBean mainBean) {
            ...
            String resource = jsonArray.toJSONString(results);
            ACache.get(getActivity()).put("resource",resource,60*60);
...
//            mainAdapter.isFirstOnly(false);
            ...
            mainAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
                ...
                public void onLoadMoreRequested() {
                    isFirstPage = false;
                    page++;
                    mainPresenter.getMainInfo("拓展资源", 10, page);
                }
            }, recyclerView);
        }
        ...
        public void onError(String result) {
            ...
            String resource = ACache.get(getActivity()).getAsString("resource");
            List<ResultsBean> resultsBeen = JSONObject.parseArray(resource, ResultsBean.class);
            if (resource==null){
                swipeRefreshLayout.setRefreshing(false);
            }else {
                swipeRefreshLayout.setRefreshing(false);
